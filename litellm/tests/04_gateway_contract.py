...
(The MLflow gateway in ../../mlflow stores none and ran to 13961 tokens on the
same prompt. Its own copy of this test asserts the opposite of this table, which
is the point: each project declares and checks its own contract.)
